    ...
    <div class="contenedor">
        ...
        <label class="icon icon-menu" for="menu-bar"></label>
                ...
                <a href="prueba.php" class="icon icon-home"> Inicio</a>
                    ...
                    <!--<a  onclick="javascript:cart();" class= "icon icon-cart"> Cart </a>-->
...
?></div>
        ...
        <footer id="footer">
            ...
            <div class="cont">
                ...
                <p class="copy">Copyright &copy; 2017-2021 GeekShop.com All rights reserved </p>
                
                <div class="sociales">
                    <a class="icon icon-facebook2" href="#"></a>
                    <a class="icon icon-twitter" href="#"></a>
                    <a class="icon icon-google-plus3" href="#"></a> </div>
              </div>
